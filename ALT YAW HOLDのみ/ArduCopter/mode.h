...
public:
    ...
    enum class Number : uint8_t {
        ...
        ALT_YAW_HOLD = 99,  // manual airframe angle with automatic throttle and yaw angle
...
class ModeAltYawHold : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::ALT_YAW_HOLD; }
...
protected:
    ...
    const char *name() const override { return "ALT_YAW_HOLD"; }
    const char *name4() const override { return "ALTY"; }
